...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#05060a] text-white relative overflow-hidden">
      ...
      {showMusic && (
        <div className="fixed top-20 left-0 right-0 z-40 max-w-xl mx-auto w-full px-5">
          <MusicPlayer />
        </div>
      )}
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-black/70 backdrop-blur-2xl safe-bottom">
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center gap-1 px-4 py-2 rounded-2xl transition-all ${
                  isActive ? 'bg-white text-black shadow-lg' : 'text-white/35 hover:text-white'
                }`}
              >
